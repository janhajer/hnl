...
//     for (auto id : ids) resonances.emplace_back(new MesonResonance(pythia, neutrino_coupling_2, id));
    for (auto id : ids) resonances.emplace_back(new NeutrinoResonance(pythia, neutrino_coupling_2, id));
    return resonances;
}
